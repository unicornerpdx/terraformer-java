...
public class LineStringTest {
    ...
    public static LineString getLinearRing() {
    ...
    public static LineString getLinearRingRotated() {
    ...
    public static LineString getLinearRingReversed() {
    ...
    public static LineString getLinearRingReversedRotated() {
    ...
    public static LineString getLinearRingWrongOrder() {
    ...
    public static LineString getLineStringDiffOrder() {
