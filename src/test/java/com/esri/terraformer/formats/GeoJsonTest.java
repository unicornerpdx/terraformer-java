...
import com.esri.terraformer.core.FeatureCollectionTest;
import com.esri.terraformer.core.FeatureTest;
import com.esri.terraformer.core.GeometryCollection;
import com.esri.terraformer.core.GeometryCollectionTest;
import com.esri.terraformer.core.GeometryType;
import com.esri.terraformer.core.LineString;
import com.esri.terraformer.core.LineStringTest;
import com.esri.terraformer.core.MultiLineString;
import com.esri.terraformer.core.MultiLineStringTest;
import com.esri.terraformer.core.MultiPoint;
import com.esri.terraformer.core.MultiPointTest;
import com.esri.terraformer.core.MultiPolygon;
import com.esri.terraformer.core.MultiPolygonTest;
import com.esri.terraformer.core.Point;
import com.esri.terraformer.core.PointTest;
import com.esri.terraformer.core.Polygon;
import com.esri.terraformer.core.PolygonTest;
...
public class GeoJsonTest {
    ...
    public static final String EMPTY_FEATURES_FEATURE_COLLECTION = "{\"type\":\"FeatureCollection\",\"features\":[]}";
    ...
    public static final String NOT_AN_OBJECT_FEATURE_COLLECTION = "[\"type\",\"features\"]";
    ...
    public static final String NO_FEATURES_FEATURE_COLLECTION = "{\"type\":\"FeatureCollection\"}";
    public static final String FEATURES_NOT_ARRAY_FEATURE_COLLECTION = "{\"type\":\"FeatureCollection\",\"features\":100.0}";

    // Feature strings
    public static final String MULTILINESTRING_FEATURE = "{\"type\":\"Feature\",\"geometry\":{\"type\":\"MultiLineString\",\"coordinates\":[[[100.0,0.0],[101.0,1.0]],[[103.0,5.0],[109.0,3.0]]]},\"properties\":{\"innerObject\":{\"herp\":\"derp\",\"nurp\":100.5},\"innerArray\":[1,2,3,4],\"horse\":\"hands\"}}";
    ...
    public static final String EMPTY_GEOMETRY_FEATURE = "{\"type\":\"Feature\",\"geometry\":{},\"properties\":{}}";
    ...
    public static final String NOT_AN_OBJECT_FEATURE = "[\"type\",\"geometry\"]";
    ...
    public static final String NO_GEOMETRY_FEATURE = "{\"type\":\"Feature\"}";
    public static final String GEOMETRY_NOT_OBJECT_FEATURE = "{\"type\":\"Feature\",\"geometry\":100.0}";
    ...
    public static final String EMPTY_GEOMETRIES_GEOMETRY_COLLECTION = "{\"type\":\"GeometryCollection\",\"geometries\":[]}";
    ...
    public static final String NOT_AN_OBJECT_GEOMETRY_COLLECTION = "[\"type\",\"geometries\"]";
    ...
    public static final String NO_GEOMETRIES_GEOMETRY_COLLECTION = "{\"type\":\"GeometryCollection\"}";
    public static final String GEOMS_NOT_ARRAY_GEOMETRY_COLLECTION = "{\"type\":\"GeometryCollection\",\"geometries\":100.0}";
    ...
    public static final String EMPTY_COORDS_MULTI_POLYGON = "{\"type\":\"MultiPolygon\",\"coordinates\":[]}";
    ...
    public static final String NOT_AN_OBJECT_MULTI_POLYGON = "[\"type\",\"coordinates\"]";
    ...
    public static final String NO_COORDINATES_MULTI_POLYGON = "{\"type\":\"MultiPolygon\"}";
    public static final String COORDS_NOT_ARRAY_MULTI_POLYGON = "{\"type\":\"MultiPolygon\",\"coordinates\":100.0}";

    // Polygon strings
    public static final String VALID_POLYGON = "{\"type\":\"Polygon\",\"coordinates\":[[[100.0,0.0],[104.0,0.0],[104.0,4.0],[100.0,4.0],[100.0,0.0]],[[101.0,0.5],[103.0,0.5],[103.0,1.0],[101.0,1.0],[101.0,0.5]],[[101.0,3.0],[103.0,3.0],[103.0,3.5],[101.0,3.5],[101.0,3.0]]]}";
    public static final String EMPTY_COORDS_POLYGON = "{\"type\":\"Polygon\",\"coordinates\":[]}";
    public static final String WRONG_TYPE_POLYGON = "{\"type\":\"MultiLineString\",\"coordinates\":[[[100.0,0.0],[104.0,0.0],[104.0,4.0],[100.0,4.0],[100.0,0.0]],[[101.0,0.5],[103.0,0.5],[103.0,1.0],[101.0,1.0],[101.0,0.5]],[[101.0,3.0],[103.0,3.0],[103.0,3.5],[101.0,3.5],[101.0,3.0]]]}";
    public static final String NO_TYPE_POLYGON = "{\"coordinates\":[[[100.0,0.0],[104.0,0.0],[104.0,4.0],[100.0,4.0],[100.0,0.0]],[[101.0,0.5],[103.0,0.5],[103.0,1.0],[101.0,1.0],[101.0,0.5]],[[101.0,3.0],[103.0,3.0],[103.0,3.5],[101.0,3.5],[101.0,3.0]]]}";
    public static final String NOT_AN_OBJECT_POLYGON = "[\"type\",\"coordinates\"]";
    // one of the linestrings is not a linear ring
    public static final String INVALID_INNER_TYPE_POLYGON = "{\"type\":\"Polygon\",\"coordinates\":[[[100.0,0.0],[104.0,0.0],[104.0,4.0],[100.0,4.0],[100.0,0.0]],[[101.0,0.5],[103.0,0.5],[103.0,1.0],[101.0,1.0]],[[101.0,3.0],[103.0,3.0],[103.0,3.5],[101.0,3.5],[101.0,3.0]]]}";
    public static final String NO_COORDINATES_POLYGON = "{\"type\":\"Polygon\"}";
    public static final String COORDS_NOT_ARRAY_POLYGON = "{\"type\":\"Polygon\",\"coordinates\":100.0}";

    // Multi Line String strings
    public static final String VALID_MULTI_LINE_STRING = "{\"type\":\"MultiLineString\",\"coordinates\":[[[100.0,0.0],[101.0,1.0]],[[103.0,5.0],[109.0,3.0]]]}";
    public static final String EMPTY_COORDS_MULTI_LINE_STRING = "{\"type\":\"MultiLineString\",\"coordinates\":[]}";
    public static final String WRONG_TYPE_MULTI_LINE_STRING = "{\"type\":\"LineString\",\"coordinates\":[[100.0,0.0],[101.0,1.0]]}";
    public static final String NO_TYPE_MULTI_LINE_STRING = "{\"coordinates\":[[[100.0,0.0],[101.0,1.0]],[[100.0,0.0],[101.0,1.0]]]}";
    public static final String NOT_AN_OBJECT_MULTI_LINE_STRING = "[\"type\",\"coordinates\"]";
    public static final String INVALID_INNER_TYPE_MULTI_LINE_STRING = "{\"type\":\"MultiLineString\",\"coordinates\":[[[100.0,0.0],[101.0,\"squid\"]],[[100.0,0.0],[101.0,1.0]]]}";
    public static final String NO_COORDINATES_MULTI_LINE_STRING = "{\"type\":\"MultiLineString\"}";
    public static final String COORDS_NOT_ARRAY_MULTI_LINE_STRING = "{\"type\":\"MultiLineString\",\"coordinates\":\"horse\"}";

    // Line String strings
    public static final String VALID_LINE_STRING = "{\"type\":\"LineString\",\"coordinates\":[[100.0,0.0],[101.0,1.0]]}";
    public static final String WRONG_TYPE_LINE_STRING = "{\"type\":\"MultiPoint\",\"coordinates\":[100.0,0.0]}";
    public static final String NO_TYPE_LINE_STRING = "{\"coordinates\":[[100.0,0.0],[101.0,1.0]]}";
    public static final String NOT_AN_OBJECT_LINE_STRING = "[\"type\",\"coordinates\"]";
    public static final String INVALID_INNER_TYPE_LINE_STRING = "{\"type\":\"LineString\",\"coordinates\":[[100.0,3.0],[100.0,\"squid\"],[101.0,1.0]]}";
    public static final String NO_COORDINATES_LINE_STRING = "{\"type\":\"LineString\"}";
    public static final String COORDS_NOT_ARRAY_LINE_STRING = "{\"type\":\"LineString\",\"coordinates\":\"horse\"}";
    public static final String COORDS_TOO_SHORT_LINE_STRING = "{\"type\":\"LineString\",\"coordinates\":[[101.0,1.0]]}";
    public static final String LINEAR_RING = "{\"type\":\"LineString\",\"coordinates\":[[100.0,0.0],[101.0,0.0],[101.0,1.0],[100.0,1.0],[100.0,0.0]]}";

    // Multi Point strings
    public static final String VALID_MULTIPOINT = "{\"type\":\"MultiPoint\",\"coordinates\":[[100.0,0.0],[101.0,1.0]]}";
    public static final String WRONG_TYPE_MULTIPOINT = "{\"type\":\"Point\",\"coordinates\":[100.0,0.0]}";
    public static final String NO_TYPE_MULTIPOINT = "{\"coordinates\":[[100.0,0.0],[101.0,1.0]]}";
    public static final String NOT_AN_OBJECT_MULTIPOINT = "[\"type\",\"coordinates\"]";
    public static final String INVALID_INNER_TYPE_MULTIPOINT = "{\"type\":\"MultiPoint\",\"coordinates\":[[100.0,3.0],[100.0,\"squid\"],[101.0,1.0]]}";
    public static final String NO_COORDINATES_MULTIPOINT = "{\"type\":\"MultiPoint\"}";
    public static final String COORDS_NOT_ARRAY_MULTIPOINT = "{\"type\":\"MultiPoint\",\"coordinates\":\"horse\"}";
    public static final String COORDS_TOO_SHORT_MULTIPOINT = "{\"type\":\"MultiPoint\",\"coordinates\":[[101.0,1.0]]}";

    // Point strings
    public static final String VALID_POINT = "{\"type\":\"Point\",\"coordinates\":[100.0,0.0,90.0,90.0]}";
    public static final String WRONG_TYPE_POINT = "{\"type\":\"MultiPoint\",\"coordinates\":[[100.0,0.0],[101.0,1.0]]}";
    public static final String NO_TYPE_POINT = "{\"coordinates\":[100.0,0.0]}";
    public static final String NOT_AN_OBJECT_POINT = "[\"type\",\"coordinates\"]";
    public static final String INVALID_INNER_TYPE_POINT = "{\"type\":\"Point\",\"coordinates\":[100.0,\"squid\"]}";
    public static final String NO_COORDINATES_POINT = "{\"type\":\"Point\"}";
    ...
    public void testGetType() throws Exception {
        ...
        JsonObject typeless = FormatUtils.getObject("{\"coordinates\":[[100.0,0.0],[101.0,1.0]]}", "derp");
        assertEquals(null, GeoJson.getType(typeless));

        JsonObject numericType = FormatUtils.getObject("{\"type\":5,\"coordinates\":[[100.0,0.0],[101.0,1.0]]}",
                                                        "derp");
        assertEquals(null, GeoJson.getType(numericType));

        JsonObject unknownType = FormatUtils.getObject(
        ...
        assertEquals(GeometryType.MULTIPOINT, GeoJson.getType(
                FormatUtils.getObject(VALID_MULTIPOINT, "derp")));
    }
    ...
    public void testGetCoordinates() throws Exception {
        ...
        try {
            GeoJson.getCoordinates(FormatUtils.getObject(NO_COORDINATES_MULTIPOINT, "derp"), "derp");
        } catch (TerraformerException e) {
        ...
        JsonObject obj = FormatUtils.getObject(VALID_MULTIPOINT, "derp");
    ...
    public void testGetCoordinateArray() throws Exception {
        ...
        try {
            GeoJson.getCoordinateArray(GeoJson.getCoordinates(
                    FormatUtils.getObject(COORDS_TOO_SHORT_MULTIPOINT, "derp"), "derp"), 2, "derp");
        } catch (TerraformerException e) {
        ...
        JsonElement elem = GeoJson.getCoordinates(FormatUtils.getObject(VALID_MULTIPOINT, "derp"), "derp");
        assertNotEquals(null, GeoJson.getCoordinateArray(elem, 2, "derp"));
    }

    @Test
    public void testGeometryFromObjectElement() throws Exception {
        Point pt = (Point) GeoJson.geometryFromObjectElement(FormatUtils.getElement(VALID_POINT, "derp"), "derp");
        MultiLineString mls = (MultiLineString) GeoJson.geometryFromObjectElement(
                FormatUtils.getElement(VALID_MULTI_LINE_STRING, "derp"), "derp");
        GeometryCollection gc = (GeometryCollection) GeoJson.geometryFromObjectElement(
                FormatUtils.getElement(VALID_GEOMETRY_COLLECTION, "derp"), "derp");

        boolean gotException = false;

        try {
            Polygon pg = (Polygon) GeoJson.geometryFromObjectElement(
                    FormatUtils.getElement(POLYGON_FEATURE, "derp"), "derp");
        } catch (TerraformerException e) {
        ...
        try {
            GeometryCollection gc2 = (GeometryCollection) GeoJson.geometryFromObjectElement(
                    FormatUtils.getElement(VALID_FEATURE_COLLECTION, "derp"), "derp");
        } catch (TerraformerException e) {
            assertTrue(e.getMessage().contains(TerraformerException.ELEMENT_NOT_GEOMETRY));
            gotException = true;
        }
    ...
    public void testFeatureFromObjectElement() throws Exception {
        Feature ft1 = GeoJson.featureFromObjectElement(FormatUtils.getElement(MULTILINESTRING_FEATURE, "derp"), "derp");
        Feature ft2 = GeoJson.featureFromObjectElement(FormatUtils.getElement(POLYGON_FEATURE, "derp"), "derp");
        Feature ft3 = GeoJson.featureFromObjectElement(FormatUtils.getElement(MULTIPOLYGON_FEATURE, "derp"), "derp");
        Feature ft4 = GeoJson.featureFromObjectElement(FormatUtils.getElement(GEOMETRYCOLLECTION_FEATURE, "derp"), "derp");

        boolean gotException = false;

        try {
            Feature ft5 = GeoJson.featureFromObjectElement(
                    FormatUtils.getElement(VALID_MULTI_POLYGON, "derp"), "derp");
        } catch (TerraformerException e) {
