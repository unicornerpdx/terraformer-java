...
public class TerraformerException extends Exception {
    ...
    public static final String FEATURES_KEY_NOT_FOUND = "\"features\": key not found";
    ...
    public static final String ELEMENT_NOT_FEATURE = "element should be a Feature, but was not";
